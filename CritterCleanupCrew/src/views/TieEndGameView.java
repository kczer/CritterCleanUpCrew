...
public class TieEndGameView extends JPanel implements ActionListener{
	ButtonView mainMenu;
	JPanel cards;
	GameView mainView;
	...
	public TieEndGameView() {
		setBackground(Color.WHITE);
		mainMenu = new ButtonView("Sorry, but you ran out of time. You didn't die though!");
	...
	public void paintComponent(Graphics g) {
		...
		Image bg = new ImageIcon("assets/tieGameImage.png").getImage();
