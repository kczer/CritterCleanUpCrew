...
public class WinEndGameView extends JPanel implements ActionListener{
	ButtonView mainMenu;
	JPanel cards;
	GameView mainView;
	...
	public WinEndGameView() {
		setBackground(Color.WHITE);
		mainMenu = new ButtonView("Congratulations, you won! Earth is now free from the Aliens!");
	...
	public void paintComponent(Graphics g) {
		...
		Image bg = new ImageIcon("assets/winGameImage.png").getImage();
